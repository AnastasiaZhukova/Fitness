package com.github.anastasiazhukova.fitness.screens.fragments.zold.food
...
object FoodScreenDependency {
    val module = module {
        scope<FoodFragment> {
            scoped<ITodayCaloriesRepository> { StubTodayCaloriesRepository() }
            scoped<ITodayWaterRepository> { StubTodayWaterRepository() }

            scoped<ITodayStatisticsUseCase> {
